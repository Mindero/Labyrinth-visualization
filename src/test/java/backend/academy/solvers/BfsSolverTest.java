...
class BfsSolverTest {
    ...
    private static Graph<Coordinate> getNotWeightedCycleGraph() {
        ...
        g.addEdge(new Coordinate(0, 0), new Coordinate(1, 0), 1);
        g.addEdge(new Coordinate(0, 1), new Coordinate(1, 1), 1);
        g.addEdge(new Coordinate(1, 0), new Coordinate(1, 1), 1);
        g.addEdge(new Coordinate(1, 0), new Coordinate(2, 0), 1);
        return g;
    }

    @Test
    void findPathFromGraph() {
        Graph<Coordinate> g = getNotWeightedCycleGraph();

        List<Coordinate> expectedPath = List.of(new Coordinate(0, 0), new Coordinate(1, 0),
            new Coordinate(2, 0));
        List<Coordinate> actualPath = bfsSolver.findPath(g,
            new Coordinate(0, 0),
            new Coordinate(2, 0));
    ...
    void findPathFromSimpleMaze() {
        ...
        List<Coordinate> expectedPath = List.of(new Coordinate(0, 0), new Coordinate(1, 0),
            new Coordinate(1, 1));
        List<Coordinate> actualPath = bfsSolver.findPath(maze,
            new Coordinate(0, 0),
            new Coordinate(1, 1));
